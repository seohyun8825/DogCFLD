...
def build_test_loader(cfg):
    ...
    test_loader = DataLoader(
        test_data,
        batch_size=cfg.TEST.MICRO_BATCH_SIZE,
        shuffle=True,
        drop_last=False,
    ...
    fid_real_data = FidRealDeepFashion(
        root_dir='/home/user/Desktop/CFLD_pl/CFLD/happy',
        test_img_size=cfg.TEST.IMG_SIZE
    )

    logger.info(f"Loading images from /home/user/Desktop/CFLD_pl/CFLD/happy")
